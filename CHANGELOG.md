...
2026-08-22, of a document that had since grown to 1309 lines in the
...
belongs to the client, which owns the browser automation surface, the
...
propagation lag — was **wrong**. See that client's run log of 2026-08-22.
